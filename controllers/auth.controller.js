...
//   // Set email or phone based on detected type
...
//   // যদি ইউজারের পাসওয়ার্ড না থাকে (সোশ্যাল লগিন ইউজার)
//   if (!user.password) {
//     return res.status(401).json({
//       status: "error",
...
// // @desc    Forgot password - ENHANCED VERSION
...
//   // Create reset URL - IMPORTANT: This should match your frontend route
...
//               </p>
//               <a href="${resetURL}" style="display: inline-block; background-color: #28a745; color: white; padding: 15px 30px; text-decoration: none; border-radius: 5px; font-weight: bold;">
//                 Reset Password
//               </a>
//             </div>
//             <p style="color: #666; text-align: center; margin: 20px 0;">
...
//             </p>
//             <p style="color: #007bff; text-align: center; word-break: break-all; font-size: 14px;">
//               ${resetURL}
//             </p>
//             <p style="color: #666; text-align: center; font-size: 14px;">
...
//       await sendSMS({
//         phone: user.phone,
//         message: `Password Reset: Click this link to reset your password: ${resetURL}. This link will expire in 10 minutes. If you did not request this, please ignore this message.`,
//       })
...
//     return next(new AppError("There was an error sending the reset link. Please try again later.", 500))
//   }
// })
